...
@Ds(entity = PurchaseInvoiceLineTax.class)
public class PurchaseInvoiceLineTax_Ds
		extends
			AbstractAuditableDs<PurchaseInvoiceLineTax> {
	...
	public PurchaseInvoiceLineTax_Ds() {
		super();
	}

	public PurchaseInvoiceLineTax_Ds(PurchaseInvoiceLineTax e) {
		super(e);
	}
