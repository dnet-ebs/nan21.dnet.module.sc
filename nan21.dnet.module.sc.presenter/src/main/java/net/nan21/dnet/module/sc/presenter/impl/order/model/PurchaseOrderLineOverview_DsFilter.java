...
import net.nan21.dnet.module.sc.presenter.impl.order.model.PurchaseOrderLineOverview_Ds;

/**
 * Helper filter object to run query by example with range values.
 *
 */
public class PurchaseOrderLineOverview_DsFilter
		extends
			PurchaseOrderLineOverview_Ds {
