 ...
 */
package net.nan21.dnet.module.sc.presenter.impl.invoice.model;
...
@Ds(entity = PurchaseInvoice.class, sort = {@SortField(field = PurchaseInvoice_Ds.f_docDate, desc = true)})
@RefLookups({
		@RefLookup(refId = PurchaseInvoice_Ds.f_docTypeId, namedQuery = DocType.NQ_FIND_BY_CODE, params = {@Param(name = "code", field = PurchaseInvoice_Ds.f_docType)}),
		@RefLookup(refId = PurchaseInvoice_Ds.f_currencyId, namedQuery = Currency.NQ_FIND_BY_CODE, params = {@Param(name = "code", field = PurchaseInvoice_Ds.f_currency)}),
		@RefLookup(refId = PurchaseInvoice_Ds.f_companyId, namedQuery = Org.NQ_FIND_BY_CODE, params = {@Param(name = "code", field = PurchaseInvoice_Ds.f_company)}),
		@RefLookup(refId = PurchaseInvoice_Ds.f_bpAccountId, namedQuery = BpAccount.NQ_FIND_BY_ORG_BP_PRIMITIVE, params = {
				@Param(name = "companyId", field = PurchaseInvoice_Ds.f_companyId),
				@Param(name = "bpartnerId", field = PurchaseInvoice_Ds.f_bpartnerId)}),
		@RefLookup(refId = PurchaseInvoice_Ds.f_paymentMethodId, namedQuery = DocType.NQ_FIND_BY_CODE, params = {@Param(name = "code", field = PurchaseInvoice_Ds.f_paymentMethod)}),
		@RefLookup(refId = PurchaseInvoice_Ds.f_paymentTermId, namedQuery = PaymentTerm.NQ_FIND_BY_NAME, params = {@Param(name = "name", field = PurchaseInvoice_Ds.f_paymentTerm)}),
		@RefLookup(refId = PurchaseInvoice_Ds.f_purchaseOrderId, namedQuery = PurchaseOrder.NQ_FIND_BY_DOCNO, params = {@Param(name = "docNo", field = PurchaseInvoice_Ds.f_purchaseOrder)})})
public class PurchaseInvoice_Ds extends AbstractAuditableDs<PurchaseInvoice> {
	...
	public PurchaseInvoice_Ds() {
		super();
	}

	public PurchaseInvoice_Ds(PurchaseInvoice e) {
		super(e);
	}
