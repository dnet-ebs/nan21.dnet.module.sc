 ...
 */
Ext.define(Dnet.ns.sc + "PurchaseOrderLine_Dc" , {
	extend: "dnet.core.dc.AbstractDc",
	recordModel: Dnet.ns.sc + "PurchaseOrderLine_Ds"
});

/* ================= FILTER: FilterCtx ================= */


Ext.define(Dnet.ns.sc + "PurchaseOrderLine_Dc$FilterCtx" , {
	extend: "dnet.core.dc.view.AbstractDcvFilterPropGrid",
	alias: "widget.sc_PurchaseOrderLine_Dc$FilterCtx",
...
Ext.define(Dnet.ns.sc + "PurchaseOrderLine_Dc$CtxList" , {
	extend: "dnet.core.dc.view.AbstractDcvGrid",
	alias: "widget.sc_PurchaseOrderLine_Dc$CtxList",
	_noImport_: true,
	_noExport_: true,
	_noPrint_: true,
...
Ext.define(Dnet.ns.sc + "PurchaseOrderLine_Dc$EditForm" , {
	extend: "dnet.core.dc.view.AbstractDcvEditForm",
	alias: "widget.sc_PurchaseOrderLine_Dc$EditForm",
