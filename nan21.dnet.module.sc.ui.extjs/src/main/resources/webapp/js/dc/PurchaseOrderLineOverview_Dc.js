 ...
 */
Ext.define(Dnet.ns.sc + "PurchaseOrderLineOverview_Dc" , {
	extend: "dnet.core.dc.AbstractDc",
	filterModel: Dnet.ns.sc + "PurchaseOrderLineOverview_DsFilter",
	paramModel: Dnet.ns.sc + "PurchaseOrderLineOverview_DsParam",
	recordModel: Dnet.ns.sc + "PurchaseOrderLineOverview_Ds"
});

/* ================= FILTER FORM: Filter ================= */			

Ext.define(Dnet.ns.sc + "PurchaseOrderLineOverview_Dc$Filter" , {
	extend: "dnet.core.dc.view.AbstractDcvFilterForm",
	alias: "widget.sc_PurchaseOrderLineOverview_Dc$Filter",
...
Ext.define(Dnet.ns.sc + "PurchaseOrderLineOverview_Dc$List" , {
	extend: "dnet.core.dc.view.AbstractDcvGrid",
	alias: "widget.sc_PurchaseOrderLineOverview_Dc$List",
	_noImport_: true,
...
Ext.define(Dnet.ns.sc + "PurchaseOrderLineOverview_Dc$DocView" , {
	extend: "dnet.core.dc.view.AbstractDcvEditForm",
	alias: "widget.sc_PurchaseOrderLineOverview_Dc$DocView",
