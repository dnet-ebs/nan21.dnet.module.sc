 ...
 */
Ext.define(Dnet.ns.sc + "VendorAccountCtxInvoice_Dc" , {
...
Ext.define(Dnet.ns.sc + "VendorAccountCtxInvoice_Dc$Filter" , {
	extend: "dnet.core.dc.view.AbstractDcvFilterPropGrid",
	alias: "widget.sc_VendorAccountCtxInvoice_Dc$Filter",
...
Ext.define(Dnet.ns.sc + "VendorAccountCtxInvoice_Dc$List" , {
	extend: "dnet.core.dc.view.AbstractDcvGrid",
	alias: "widget.sc_VendorAccountCtxInvoice_Dc$List",
	_noImport_: true,
	...
	_defineColumns_: function() {
		...
		.addTextColumn({ name:"sourceDocNo", dataIndex:"sourceDocNo", width:200})
