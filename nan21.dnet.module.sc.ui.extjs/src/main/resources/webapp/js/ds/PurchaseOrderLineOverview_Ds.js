...
Ext.define(Dnet.ns.sc + "PurchaseOrderLineOverview_Ds", {
...
Dnet.createFilterModelFromRecordModel({
	...
	recordModelFqn: Dnet.ns.sc + "PurchaseOrderLineOverview_Ds"
});

Ext.define(Dnet.ns.sc + "PurchaseOrderLineOverview_DsParam", {
	extend: 'Ext.data.Model',
