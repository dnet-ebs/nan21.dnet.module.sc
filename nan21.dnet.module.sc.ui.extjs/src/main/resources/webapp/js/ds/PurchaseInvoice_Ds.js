...
Ext.define(Dnet.ns.sc + "PurchaseInvoice_Ds", {
	extend: 'Ext.data.Model',
	
	validations: [
		{field: "docDate", type: 'presence'},
		{field: "sourceDocNo", type: 'presence'},
...
Dnet.createFilterModelFromRecordModel({
	...
	recordModelFqn: Dnet.ns.sc + "PurchaseInvoice_Ds"
});

Ext.define(Dnet.ns.sc + "PurchaseInvoice_DsParam", {
	extend: 'Ext.data.Model',
